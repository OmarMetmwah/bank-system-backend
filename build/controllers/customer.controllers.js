...
exports.create = exports.history = exports.list = void 0;
var customer_model_1 = __importDefault(require("../models/customer.model"));
var customerModel = new customer_model_1.default();
var list = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, customerModel.list()];
            case 1:
                users = _a.sent();
...
exports.list = list;
var history = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var users, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, customerModel.history(req.params.name)];
            case 1:
                users = _a.sent();
                res.json({ status: 'success', data: users });
                return [3 /*break*/, 3];
...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_3 = _a.sent();
                res.json({ status: 'fail', data: err_3.message });
                next(err_3);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
